      ...
      <div className="container mx-auto py-8 px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="space-x-4">
            <Link href="/admin/chat-logs" className="bg-primary-600 text-white py-2 px-4 rounded hover:bg-primary-700 transition">
              Chat Logs
            </Link>
            <Link href="/admin/contact-submissions" className="bg-primary-600 text-white py-2 px-4 rounded hover:bg-primary-700 transition">
              Contact Submissions
            </Link>
            <Link href="/admin/job-applications" className="bg-primary-600 text-white py-2 px-4 rounded hover:bg-primary-700 transition">
              Job Applications
            </Link>
          </div>
        </div>
